...
all_figures["comparaison_plongement_classification_N_best"] = \
    vt.f1_macro_per_model_and_method(data, N = N_best, onlyDisplayBestEpoch = onlyDisplayBestEpoch)
...
vt.f1_macro_per_n_sample_and_method(data, N = None, onlyDisplayBestEpoch = onlyDisplayBestEpoch)
...
all_figures["comparaison_lr_model_method_N_best"] = \
    vt.f1_macro_lr_per_model_and_method(data, N = N_best, onlyDisplayBestEpoch = onlyDisplayBestEpoch)
